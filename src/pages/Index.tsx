  ...
  return (
    <div className="min-h-screen font-montserrat" style={{ background: "#060d1f" }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex items-center justify-between h-20">
          <button onClick={() => scrollTo("home")} className="flex flex-col items-start">
            <span className="font-cormorant text-2xl tracking-widest leading-none" style={{ color: "#b8c4d0" }}>
              НОВЫЙ ВЗГЛЯД
            </span>
          ...
          >
            {[
              ...
              >
                ...
                <h3 className="font-cormorant text-lg font-light mb-4" style={{ color: "rgba(221,230,238,0.8)" }}>{item.title}</h3>
      ...
      <footer className="py-10 text-center" style={{ borderTop: "1px solid rgba(184,196,208,0.1)" }}>
        <p className="font-cormorant text-2xl tracking-widest mb-2" style={{ color: "#b8c4d0" }}>НОВЫЙ ВЗГЛЯД</p>
